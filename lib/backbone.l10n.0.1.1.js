Backbone.View.prototype.l10n = function(str) {
    var lang = this.l10nLang?this.l10nLang:((this.router && this.router.l10nLang)?this.router.l10nLang:'dev')
    if(lang == 'dev') return str;
...
Backbone.Router.prototype.l10nLang = 'dev';
